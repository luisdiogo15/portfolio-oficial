...
export function Hero() {
  ...
  return (
    <section id="home" className="fade-in-section mx-auto max-w-6xl px-6 pb-24 pt-32" aria-labelledby="home-title">
      <p className="mb-4 text-sm font-semibold uppercase tracking-[0.18em] text-sky-700 dark:text-sky-400">{hero.saudacao}</p>
      <h1
        id="home-title"
      ...
      <p className="mt-6 max-w-2xl text-lg leading-relaxed text-slate-700 dark:text-slate-300">{hero.descricao}</p>
